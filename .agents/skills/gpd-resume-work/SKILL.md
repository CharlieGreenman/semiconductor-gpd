...
<required_reading>
<!-- @ include not resolved: ./.codex/get-physics-done/references/orchestration/continuation-format.md -->
</required_reading>
...
```bash
INIT=$(/Users/charlie/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local init resume)
if [ $? -ne 0 ]; then
...
<process>
**Follow the resume-work workflow** from `@./.codex/get-physics-done/workflows/resume-work.md`.
