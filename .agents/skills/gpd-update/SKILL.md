...
```bash
GPD_INSTALL_DIR="./.codex/get-physics-done"
GPD_CONFIG_DIR="./.codex"
GPD_GLOBAL_CONFIG_DIR="/Users/charlie/.codex"
...
```bash
rm -f \
  "./.codex/cache/gpd-update-check.json" \
  "/Users/charlie/.codex/cache/gpd-update-check.json" \
...
<process>
**Follow the update workflow** from `@./.codex/get-physics-done/workflows/update.md`.
