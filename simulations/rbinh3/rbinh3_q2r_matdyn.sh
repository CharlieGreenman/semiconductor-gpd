#!/bin/bash
# RbInH3 phonon post-processing: q2r.x -> matdyn.x
# ASSERT_CONVENTION: asr_enforcement=crystal, unit_system_internal=Rydberg_atomic
#
# Step 1: Convert dynamical matrices to real-space force constants
# Step 2: Interpolate phonon dispersion along high-symmetry path
# Step 3: Compute phonon DOS for ZPE and thermodynamic properties
#
...
# Pm-3m (simple cubic) high-symmetry path: Gamma-X-M-Gamma-R-X|M-R
...
0.500 0.500 0.000  20  ! M -> R not standard but useful
EOF
# Note: M-R segment optional
