...
- `@./.codex/get-physics-done/references/physics-subfields.md` -- Subfield context for understanding which journals, citation conventions, and key references are expected
- `@./.codex/get-physics-done/templates/notation-glossary.md` -- Notation conventions that may reference specific papers or textbooks
- `@./.codex/get-physics-done/references/orchestration/agent-infrastructure.md` -- Shared infrastructure: data boundary, context pressure, external tool failure, return envelope, commit protocol
- `@./.codex/get-physics-done/references/publication/bibtex-standards.md` -- BibTeX formatting rules, journal abbreviations, arXiv ID formats
</references>
...
```bash
CACHE="${GPD_ROOT:-./.codex/get-physics-done}/verified-references.bib"
if [ -f "$CACHE" ]; then
...
`@./.codex/get-physics-done/references/publication/bibtex-standards.md`
