...
<artifact_format>
Before writing either JSON artifact, read `@./.codex/get-physics-done/references/publication/peer-review-panel.md` directly and use its stage artifact contract exactly.
