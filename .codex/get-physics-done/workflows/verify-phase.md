...
<required_reading>
@./.codex/get-physics-done/references/verification/core/verification-core.md
@./.codex/get-physics-done/references/verification/core/verification-numerical.md
@./.codex/get-physics-done/references/protocols/error-propagation-protocol.md
@./.codex/get-physics-done/templates/verification-report.md
</required_reading>
...
**Verification independence:** Load only what the verifier needs to judge results on their own merits. See @./.codex/get-physics-done/references/verification/meta/verification-independence.md.
...
for plan in "$phase_dir"/*-PLAN.md; do
  /Users/charlie/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local frontmatter get "$plan" --field contract
done
```
...
```bash
for plan in "$phase_dir"/*-PLAN.md; do
  ARTIFACT_RESULT=$(/Users/charlie/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local verify artifacts "$plan")
...
```bash
for plan in "$phase_dir"/*-PLAN.md; do
  CHECKS_RESULT=$(/Users/charlie/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local verify plan "$plan")
...
5. Reference: @./.codex/get-physics-done/workflows/numerical-convergence.md for detailed methodology
...
Reference: @./.codex/get-physics-done/references/verification/core/verification-core.md (+ relevant domain verification file)
...
See ./.codex/get-physics-done/templates/verification-report.md for complete template.
</step>
