...
```bash
/Users/charlie/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local frontmatter validate .gpd/phases/XX-name/XX-YY-PLAN.md --schema plan
/Users/charlie/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local validate plan-contract .gpd/phases/XX-name/XX-YY-PLAN.md
```
